import { SubnetAllocator, CidrTracker, CidrError, AllocationError } from '../../../src/index';
...
describe('SubnetAllocator', () => {
  ...
  describe('handleCidrError', () => {
    test('should wrap CidrError in AllocationError', () => {
      // Arrange
      const error = new CidrError('Invalid CIDR');
      ...
      try {
        ...
        expect(err.message).toContain('Invalid CIDR');
      }
    });
