import { writeAllocationsToCsv, filterAllocationsByProvider, OutputError } from '../../src/output/csv-writer';
...
describe('CSV Writer', () => {
  ...
  beforeEach(() => {
    ...
    (fs.mkdirSync as jest.Mock).mockImplementation(() => { /* intentionally empty - directory creation is mocked */ });
  ...
  describe('writeAllocationsToCsv', () => {
    ...
    it('should throw OutputError if writing fails', async () => {
