...
The `@subnetter/core` package contains the core functionality for CIDR allocation. It's organized into several key directories:
...
├── release.yml               # Workflow for semantic versioning and releases
