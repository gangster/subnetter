...
[![Documentation](https://github.com/gangster/subnetter/actions/workflows/ci-cd.yml/badge.svg?branch=main&event=push)](https://gangster.github.io/subnetter/)
[![Docs Status](https://img.shields.io/badge/docs-online-brightgreen.svg)](https://gangster.github.io/subnetter/)
[![PR Checks](https://github.com/gangster/subnetter/actions/workflows/ci-cd.yml/badge.svg?branch=main&event=pull_request)](https://github.com/gangster/subnetter/actions/workflows/ci-cd.yml)
...
Subnetter is currently in active development. The core functionality for CIDR allocation is implemented and available through both the CLI and programmatic API. The project follows a monorepo structure with comprehensive test coverage and documentation.
...
The project documentation includes user guides, architecture overview, CIDR primer, and API reference. You can access the full documentation at:

📚 **[Subnetter Documentation](https://gangster.github.io/subnetter/)**

The documentation includes:
- [User Guide](https://gangster.github.io/subnetter/user-guide)
- [Architecture](https://gangster.github.io/subnetter/architecture)
- [CIDR Primer](https://gangster.github.io/subnetter/cidr-primer)
- [API Reference](https://gangster.github.io/subnetter/api/overview)
- [Example Scenarios](https://gangster.github.io/subnetter/example-scenarios)
...
Comprehensive documentation is available in the online documentation site:

- **Developer Guide**: Detailed information for developers who want to understand, modify, or extend the codebase.
- **CIDR Primer**: An educational document explaining IP addressing concepts relevant to Subnetter.
- **Troubleshooting Guide**: Solutions for common issues encountered when using Subnetter.
- **Example Scenarios**: Hypothetical examples of how organizations could use Subnetter to solve complex IP addressing challenges.
- **API Reference**: Detailed reference for developers who want to use Subnetter programmatically.
